...
namespace NotesAppConsole
{
    class Actions 
    {
        public static string NoteDirectory = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"\Notes\";
        private static void NewNote()
        {
            ...
            NoteSettings.ConformanceLevel = ConformanceLevel.Auto; NoteSettings.Indent = true;
            ...
            using (XmlWriter NewNote = XmlWriter.Create(NoteDirectory + FileName, NoteSettings))
            {
                ...
                NewNote.WriteEndElement(); NewNote.Flush();
                NewNote.Close();
            }
        ...
        private static void EditNote()
        {
            ...
            if (File.Exists(NoteDirectory + FileName))
            {
                ...
                try
                {
                    ...
                    string ReadInput = Console.ReadLine(); if (ReadInput.ToLower() == "cancel")
                    {
                        Main(null);
                    }
                    else
        ...
        private static void ShowNotes()
        {
            ...
            { 
                ...
                else { Console.WriteLine("No notes found.\n"); 
                } 
            } 
            else 
            { 
        ...
        private static void ReadCommand()
        {
            ...
            string Command = Console.ReadLine(); switch (Command.ToLower())
            {
                case "new":
                    NewNote();
                    Main(null);
